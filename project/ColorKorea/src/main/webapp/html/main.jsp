...
<body>
    <div class="wrap">
        ...
        <section class="content">
            ...
            <div class="mainimage">
                <!-- <img src="../image/제작자료1.png" alt="" usemap="#Map"> -->
                <img src="../image/제작자료1.png" alt="">
                <!-- <map name="Map" id="Map">
                    <area shape="poly" coords="146,41,99,88,110,127,137,111,153,135,139,146,110,143,118,205,170,204,205,177,206,132,184,119,183,94,191,83,164,61,141,36" href="gyung.html" alt="경기도" id="gyeonggido">
                </map> -->
                <div class="area" id="seoul">Seoul<br> <a href="seoul.html" class="btn">이동하기</a></div>
                <div id="seoul_1"><img class="red" id="seoul_red" src="../image/red.png" alt="" style="width: 8px; height: 8px;" ></div>
                <div class="area" id="gyeonggi">Gyeong<br>Gi <div><a href="gyeonggi.jsp" class="btn">더보기</a></div></div>
                <div><img class="red" id="gyeonggi_red" src="../image/red.png" alt="" style="width: 8px; height: 8px;" ></div>
                <div class="area" id="chungbuk">
                    <div> Chung<br>Buk <div><a href="chungbuk.html" class="btn">더보기</a></div></div>
                </div>
                <div><img class="red" id="chungbuk_red" src="../image/red.png" alt="" style="width: 8px; height: 8px;" ></div>
                <div class="area" id="chungnam">Chung<br>Nam <div><a href="chungnam.html" class="btn">더보기</a></div></div>
                <div><img class="red" id="chungnam_red" src="../image/red.png" alt="" style="width: 8px; height: 8px;" ></div>
                <div class="area" id="jeollanam">Jeol<br>Nam <div><a href="jeolnam.html" class="btn">더보기</a></div></div>
                <div><img class="red" id="jeollanam_red" src="../image/red.png" alt="" style="width: 8px; height: 8px;" ></div>
                <div class="area" id="jeollabuk">Jeol<br>Buk <div><a href="jeolbuk.html" class="btn">더보기</a></div></div>
                <div><img class="red" id="jeollabuk_red" src="../image/red.png" alt="" style="width: 8px; height: 8px;" ></div>
                <div class="area" id="gangwon">Gang<br>Won <div><a href="gangwon.html" class="btn">더보기</a></div></div>
                <div><img class="red" id="gangwon_red" src="../image/red.png" alt="" style="width: 8px; height: 8px;" ></div>
                <div class="area" id="gyeongbuk">Gyeong<br>Buk <div><a href="gyeongbuk.html" class="btn">더보기</a></div></div>
                <div><img class="red" id="gyeongbuk_red" src="../image/red.png" alt="" style="width: 8px; height: 8px;" ></div>
                <div class="area" id="gyeongnam">Gyeong<br>Nam <div><a href="gyeongnam.html" class="btn">더보기</a></div></div>
